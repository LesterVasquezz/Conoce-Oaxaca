...
public class ArbolDelTuleVallesCentrales extends Activity {
    Button vBtnUbicacion;
    MediaPlayer vMdpClick;
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.arbol_del_tule_valles_centrales);
        vBtnUbicacion = (Button) findViewById(R.id.btnUbicacion);

        vBtnUbicacion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                vMdpClick= MediaPlayer.create(ArbolDelTuleVallesCentrales.this,R.raw.blop);
                vMdpClick.start();
                Uri gmmIntentUri = Uri.parse("geo:17.046650,-96.636108?q=Árbol+del+Tule+Oaxaca");
