...
public class OllasDeBarroNegroVallesCentrales extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ollas_barro_negro_valles_centrales);
        vBtnUbicacion = (Button) findViewById(R.id.btnUbicacion);

        vBtnUbicacion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                vMdpClick= MediaPlayer.create(OllasDeBarroNegroVallesCentrales.this,R.raw.blop);
                vMdpClick.start();
                Uri gmmIntentUri = Uri.parse("geo:16.950702,-96.706326?q=San+Bartolo+Coyotepec+Oaxaca");
