...
public class FigurillasDePalmaCaniada extends Activity{
    Button vBtnUbicacion;
    MediaPlayer vMdpClick;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.figurillas_de_palma_caniada);
        vBtnUbicacion=(Button)findViewById(R.id.btnUbicacion);

        vBtnUbicacion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                vMdpClick= MediaPlayer.create(FigurillasDePalmaCaniada.this,R.raw.blop);
                vMdpClick.start();
                Uri gmmIntentUri = Uri.parse("geo:18.127733, -97.068595?q=Mercado+municipal+ Morelos+San+Isidro+Teotitlán+de+Flores+Magón");
