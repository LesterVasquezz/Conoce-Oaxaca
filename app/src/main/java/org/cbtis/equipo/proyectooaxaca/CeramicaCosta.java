...
public class CeramicaCosta extends Activity {
    Button vBtnUbicacion;
    MediaPlayer vMdpClick;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ceramicadecolores_costa);
        vBtnUbicacion = (Button) findViewById(R.id.btnUbicacion);

        vBtnUbicacion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                vMdpClick= MediaPlayer.create(CeramicaCosta.this,R.raw.blop);
                vMdpClick.start();
                Uri gmmIntentUri = Uri.parse("geo:15.865269,-97.079485?q=Puerto+Escondido+Oaxaca");
